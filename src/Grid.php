...
class Grid
{
    ...
    public function render(): string
    {
        ...
        return view('grid_view::grid', [
            ...
            'searchButtonClass' => $this->getSearchButtonClass(),
            'searchButtonStyle' => $this->getSearchButtonStyle(),
            'resetButtonLabel' => $this->getResetButtonLabel(),
            'resetButtonClass' => $this->getResetButtonClass(),
            'resetButtonStyle' => $this->getResetButtonStyle(),
